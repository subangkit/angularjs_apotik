angular.module('app.inventory',['app.main'])
    .controller('CInventory', ['$scope', function ($scope) {
        console.info('CInventory');
    }])
    .controller('CInventorySummary', ['$scope', function ($scope) {
        console.info('CInventorySummary');
    }])
    .controller('CInventoryProcurement', ['$scope', function ($scope) {
        console.info('CInventoryProcurement');
    }])
    .controller('CInventoryInventory', ['$scope', function ($scope) {
        console.info('CInventoryInventory');
    }])
    .controller('CInventoryGroup', ['$scope', 'dxData', function ($scope, dxData) {
    ...
    .controller('CInventoryVendor', ['$scope', 'dxData', function ($scope, dxData) {
