angular
    ...
    .controller('CCatalog', function ($scope, dxData) {
    })
    .controller('CCatalogProduct', function ($scope, dxData) {
    ...
    .controller('CCatalogCombination', function ($scope, dxData) {
        $scope.dxDataCatalog = new dxData({
            rest: 'combinations/',
            token: '4OrAp2dhkJWI0QqEclugsSs5utlRTj',
    ...
    .controller('CCatalogPromotion', function ($scope) {
        console.info('CCatalogPromotion');
    })
    .controller('CCatalogAttribute', function ($scope, dxData) {
        $scope.dxDataAttribute = new dxData({
            rest: 'productattributes/',
            token: '4OrAp2dhkJWI0QqEclugsSs5utlRTj',
            useID: ['product', 'creator',],
    ...
    .controller('CCatalogCategory', function ($scope, dxData) {
        $scope.dxDataProductCategory = new dxData({
            rest: 'productcategories/',
            token: '4OrAp2dhkJWI0QqEclugsSs5utlRTj',
        })
    ...
    .controller('CCatalogPrice', function ($scope) {
