angular.module('app.main', [])
    .factory('dxData', function (Restangular, promiseTracker) {
    ...
    .controller('COverview', function ($scope) {
    })
    .controller('CReference', function ($scope) {
        console.info('CReference');
    })
    .controller('CReferenceTerritory', function ($scope) {
        console.info('CReferenceTerritory');
    })
    .controller('CReferenceBranch', function ($scope) {
